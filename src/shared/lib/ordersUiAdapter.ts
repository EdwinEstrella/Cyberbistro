...
export const openOperatingCycle = (id: string, businessDay: string, openingCash: number, cycleNumber: number, openedAt: string, sucursalId?: string | null) =>
  executeOrdersCommand({
