          ...
          <div className="bg-[#131313] border border-[rgba(255,144,109,0.3)] rounded-[20px] shadow-[0px_0px_30px_rgba(255,144,109,0.15)] max-w-[460px] w-full p-6 relative">
            ...
            <form onSubmit={crearInsumo} className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="font-['Inter',sans-serif] text-[#adaaaa] text-[10px] uppercase tracking-[0.5px]">Unidad Base *</label>
                  <select
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="font-['Inter',sans-serif] text-[#adaaaa] text-[10px] uppercase tracking-[0.5px]">Costo Inicial</label>
                  <input
                    type="number"
                    step="any"
                    min="0"
