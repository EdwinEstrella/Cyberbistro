...
ALTER TABLE tenant_users ADD CONSTRAINT tenant_users_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES tenants (id) ON DELETE CASCADE;-- RPC para que el dueño (admin) de un restaurante pueda eliminar un usuario de staff y desenlazarlo
