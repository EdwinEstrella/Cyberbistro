// Frozen snapshot of electron/persistence/schema.ts at release v12.1.29.
// Used by schema-upgrade tests to build a database exactly as that release left it.
// Do not edit: regenerate with `git show v12.1.29:electron/persistence/schema.ts`.
