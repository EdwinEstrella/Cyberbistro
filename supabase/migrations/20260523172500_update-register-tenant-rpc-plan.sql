-- Update cyberbistro_register_tenant RPC to support selecting professional or basic plan at sign up
DROP FUNCTION IF EXISTS public.cyberbistro_register_tenant(uuid, text, text, text, text, text);
