...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  activateTenant: (tenantId) => ipcRenderer.invoke('tenant-store:activate', tenantId),
  ...
  executePurchaseCommand: (command) => ipcRenderer.invoke('cash-purchase-repository:execute', command),
  listCompras: (filter) => ipcRenderer.invoke('compras:list', filter),
  ...
  listCxpPagos: (filter) => ipcRenderer.invoke('cxp-pagos:list', filter),
  ...
  executeCustomerCommand: (command) => ipcRenderer.invoke('customer-repository:execute', command),
